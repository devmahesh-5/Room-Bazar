...
var require_dist = __commonJS({
  "node_modules/unique-username-generator/dist/index.js"(exports) {
    ...
    var getRandomInt = (min = 0, max = 4294967295) => Math.random() * ((max | 0) - (min | 0) + 1) + (min | 0) | 0;
    var randomNumber = (maxNumber) => {
      ...
      switch (maxNumber) {
        ...
        case 3:
          ...
          break;
        case 4:
          randomNumberString = Math.floor(getRandomInt(1e3, 9e3)).toString();
          break;
        case 5:
          randomNumberString = Math.floor(getRandomInt(1e4, 9e4)).toString();
          break;
        case 6:
          randomNumberString = Math.floor(getRandomInt(1e5, 9e5)).toString();
          break;
        default:
          randomNumberString = "";
          break;
